...
export const SPECIAL_ABILITY_DESCRIPTIONS = {
  ...
  フィニッシャー: '決定機・大決定機で自身がシューターなら、シュート判定 +10%。', ミドルシューター: '難しいシュートで自身がシューターなら、シュート判定 +10%。', ポストプレーヤー: 'パス攻撃値 +6%。', 個人技: 'ドリブル攻撃時、自身のドリブル寄与 +10%。', 勝負強さ: '残り10分以内の同点・1点ビハインドで自身がシューターなら、シュート判定 +8%。', エース: 'シューター選択時、自身の選択重み +20%。'
};
