...
const OVERALL_WEIGHTS = {
  FIXO: { defense: .35, pass: .25, speed: .20, dribble: .10, shoot: .10 },
  ALA: { speed: .25, dribble: .25, pass: .20, shoot: .20, defense: .10 },
  PIVO: { shoot: .35, dribble: .25, pass: .15, speed: .15, defense: .10 },
...
export function calculateOverall(player) {
  const weights = OVERALL_WEIGHTS[player.primaryPosition] || OVERALL_WEIGHTS.ALA;
