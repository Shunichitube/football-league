import { applySeasonFinances, awards, createLeague, finalizeSeason, simulateRemainingSeason, standings, startNextSeason } from './league.js?v=0.16.1';
import { STAT_LABELS } from './data.js?v=0.16.1';
import { createRandom } from './random.js';
import { createAuctionPool, createDraftPool, resolveAuctionActions, resolveDraftActions } from './market.js?v=0.16.1';
import { escapeHtml as e, renderLineupEditor, renderMatchDetail, renderPlayerCard, renderPlayerDetail, renderRosterPanel, renderSeasonMatchList, renderSeasonPlayerStats } from './ui.js?v=0.16.1';
import { decideCpuAuctionAction, decideCpuDraftAction, prepareCpuClubs, prepareCpuMarketSpace, processLeagueOffseason, selectBestLineup } from './cpu.js?v=0.16.1';
import { ACTION_TYPES, applyClubAction, createLineupPlacement, validateLineup } from './rules.js?v=0.16.1';
...
function title(){return `<main class="title"><p>5人制クラブ運営ゲーム</p><h1>FOOTBALL<br><b>LEAGUE</b></h1><button data-a="setup">新しく始める</button><button data-stage19="loadTitle" class="subtle">続きから</button><footer>v0.16.1・Stage 21</footer></main>`}
...
import { renewalFee, trainingSkills } from './development.js?v=0.16.1';
...
import { exportSave, importSave, loadSlot, saveSlot, slotInfo } from './storage.js?v=0.16.1';
