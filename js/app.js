import { applySeasonFinances, awards, createLeague, simulateRemainingSeason, standings, startNextSeason } from './league.js?v=0.12.0';
...
function title(){return `<main class="title"><p>5人制クラブ運営ゲーム</p><h1>FOOTBALL<br><b>LEAGUE</b></h1><button data-a="setup">新しく始める</button><footer>v0.13.1・Stage 18</footer></main>`}
