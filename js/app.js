...
function title(){return `<main class="title"><p>5人制クラブ運営ゲーム</p><h1>FOOTBALL<br><b>LEAGUE</b></h1><button data-a="setup">新しく始める</button><button data-stage19="loadTitle" class="subtle">続きから</button><footer>v0.14.0・Stage 19</footer></main>`}
...
import { exportSave, importSave, loadSlot, saveSlot, slotInfo } from './storage.js';
