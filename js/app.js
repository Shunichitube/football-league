...
import { decideCpuAuctionAction, decideCpuDraftAction, prepareCpuClubs, prepareCpuMarketSpace, processLeagueOffseason, selectBestLineup } from './cpu.js?v=0.16.0';
import { ACTION_TYPES, applyClubAction, createLineupPlacement, validateLineup } from './rules.js?v=0.16.0';
...
function title(){return `<main class="title"><p>5人制クラブ運営ゲーム</p><h1>FOOTBALL<br><b>LEAGUE</b></h1><button data-a="setup">新しく始める</button><button data-stage19="loadTitle" class="subtle">続きから</button><footer>v0.16.0・Stage 21</footer></main>`}
...
import { renewalFee, trainingSkills } from './development.js?v=0.16.0';
...
import { exportSave, importSave, loadSlot, saveSlot, slotInfo } from './storage.js?v=0.16.0';
